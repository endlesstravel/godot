...
namespace Godot
{
    public static partial class GD
    {
        ...
        {
            godot_icall_GD_print(Array.ConvertAll(what, x => x != null ? x.ToString() : "null"));
        }
        ...
        {
            godot_icall_GD_printerr(Array.ConvertAll(what, x => x != null ? x.ToString() : "null"));
        }

        public static void PrintRaw(params object[] what)
        {
            godot_icall_GD_printraw(Array.ConvertAll(what, x => x != null ? x.ToString() : "null"));
        }

        public static void PrintS(params object[] what)
        {
            godot_icall_GD_prints(Array.ConvertAll(what, x => x != null ? x.ToString() : "null"));
        }

        public static void PrintT(params object[] what)
        {
            godot_icall_GD_printt(Array.ConvertAll(what, x => x != null ? x.ToString() : "null"));
        }
